...
- **Data Tools:** Pandas, NumPy, ChromaDB
- **Automation:** n8n
- **Other:** Git, Android (TensorFlow Lite)
...
├── assets/
│   ├── css/        # Stylesheets
│   ├── js/         # JavaScript (GSAP animations, etc.)
│   └── thumbnail/  # Images and icons
├── index.html      # Main entry point
└── CV - Johannes Baptista Adiatmaja Pambudi.pdf
```

## 🌟 Key Projects

- **ASAH:** Waste Classification Mobile App (94% accuracy, MobileNetV2).
- **Gender Classification:** Fingerprint Analysis Thesis (Gabor filter feature extraction).

---
© 2025 Johannes Baptista Adiatmaja Pambudi
